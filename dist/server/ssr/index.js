...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-CUGCHpBL.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-HrAU8rNt.js");
		return {
			get "ErrorBoundary"() {
	...
	"66df6da8ba41": async () => {
		const m = await import("./assets/PortfolioExperience-BEDbXKDv.js");
		return { get "PortfolioExperience"() {
			return m["PortfolioExperience"];
		} };
	},
	"8c0f216c4604": async () => {
