globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/query-D8Wk3mvj.js","assets/PortfolioExperience-FOC5SAYu.js","assets/layout-segment-context-BFqo5tJ-.js","assets/router-CjnuIBFn.js"];
...
function getDraftSecret() {
	return "cc51766c-bd02-4c74-ba77-da2d5a8b3f5f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "13cb15f4-f062-49cb-b7a1-8bfe892d4b8c";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "13cb15f4-f062-49cb-b7a1-8bfe892d4b8c") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "13cb15f4-f062-49cb-b7a1-8bfe892d4b8c",
		rootBoundaryId
	});
}
/**
...
var PortfolioExperience = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'PortfolioExperience' is called on server");
}, "66df6da8ba41", "PortfolioExperience");
//#endregion
//#region app/page.tsx
var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PortfolioExperience, {});
}
...
var metadata = {
	title: "Meena Vuppu — Product Designer",
	description: "A pegboard-style portfolio for product designer Meena Vuppu.",
	icons: {
		icon: "/favicon.svg",
...
async function ProjectRoute({ params }) {
	const { slug } = await params;
	const project = getProject(slug);
	if (!project) notFound();
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PortfolioExperience, { initialProject: project });
}
//#endregion
...
var __publicFiles = new Set([
	"/airpods-max-lavender.png",
	"/airpods-max.png",
	"/ceramic-watercolor-holder-clean.png",
	"/ceramic-watercolor-holder.png",
	"/desk-decor-cutout.png",
	"/desk-decor-v1.png",
	"/favicon.svg",
	"/file.svg",
	"/globe.svg",
	"/lemonade-by-sakura-girl.mp3",
	"/meena-photo.jpeg",
	"/money-plant-clean.png",
	"/money-plant.png",
	"/on-pin.mp3",
	"/page-flip.mp3",
	"/page-turn.mp3",
	"/pegboard-place.wav",
	"/project-open.mp3",
	"/spinopel-ceramic-tile-411505.mp3",
	"/water-brush-holder-v2.png",
	"/water-brush-holder.png",
	"/watercolour-holder-v2.png",
	"/watercolour-holder.png",
	"/window.svg"
]);
